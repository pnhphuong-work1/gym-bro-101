...
const Subscription = () => {
    return (
        <div className='bg-red-500 w-full h-full flex flex-col items-center justify-center pb-10'>
            ...
            <div className="flex justify-center items-center w-[70%] h-[70%] mt-5">
                {/* First square */}
                <div className="w-[30%] h-full bg-red-500 flex flex-col items-center justify-center pb-5 mt-3">
                    <p className="text-center text-4xl font-bold mt-2">T2, T4, T6</p>
                ...
                <div
                    ...
                    <p className="text-center text-4xl font-bold text-white mt-2">Full weak</p>
                    <div className="w-[80%] h-0.5 bg-white mt-4"></div>
                    <div className='flex mt-5'>
                ...
                {/* Third square */}
                <div className="w-[30%] h-full bg-red-500 flex flex-col items-center justify-center pb-5 mt-3">
                    <p className="text-center text-4xl font-bold mt-2">T3, T5, T7</p>
                    <div className="w-[80%] h-0.5 bg-white mt-4"></div>
                    <div className='flex mt-5'>
                        <h2 className='text-4xl'>40$</h2>
                        <p className='text-white text-xl'>/month</p>
