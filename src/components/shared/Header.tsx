...
const Header = () => {
    ...
    return (
        <div className='bg-red-600 h-[10%] w-full top-0 flex items-center justify-between'>
            <div className='text-white font-bold flex items-center ml-20'>
                {/* Phone SVG */}
            ...
            <div className='text-white flex-row items-center font-bold flex'>
                <svg width="20" height="20" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <h3 className='ml-2 mr-4'>Lô E2a-7, Đường D1 Khu Công nghệ cao, P. Long Thạnh Mỹ, TP. Thủ Đức</h3>
